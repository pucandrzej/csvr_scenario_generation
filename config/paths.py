...
RAW_BENCHMARK_RESULTS_DIR = "BENCHMARK_FORECASTING_SIMULATION_RESULTS"
...
RAW_MAE_CRPS_RESULTS_DIR = "MAE_CRPS_RESULTS"
os.makedirs(MAE_CRPS_RESULTS_DIR, exist_ok=True)

RAW_DM_MAE_CRPS_RESULTS_DIR = "DM_MAE_CRPS_RESULTS"
DM_MAE_CRPS_RESULTS_DIR = os.path.join(ROOT, RAW_DM_MAE_CRPS_RESULTS_DIR)
os.makedirs(DM_MAE_CRPS_RESULTS_DIR, exist_ok=True)
...
RAW_STRATEGY_RESULTS_DIR = "TRADING_STRATEGIES_RESULTS"
